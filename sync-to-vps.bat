...
chcp 65001 > nul
echo =================================================================
echo 🔄 SCRIPT ĐỒNG BỘ CODE TỪ MÁY TÍNH CÁ NHÂN LÊN VPS LINUX
echo =================================================================
echo.

set /p msg="Nhập ghi chú cập nhật (commit message, nhấn Enter nếu dùng mặc định): "
...
echo.
set /p vpsurl="Nhập địa chỉ IP/Domain VPS (ví dụ: http://123.45.67.89:3000 hoặc nhấn Enter dùng localhost:3000): "
